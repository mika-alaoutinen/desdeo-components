...
export { default as BarChartComponent } from './components/barChart/BarChart'
export { default as StackedBarChartComponent } from './components/barChart/StackedBarChart'
